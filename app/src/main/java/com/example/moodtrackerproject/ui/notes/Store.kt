...
import com.example.moodtrackerproject.ui.home.HomeViewState
...
object Store {
    ...
    fun setState(newState: HomeViewState) {
    ...
    fun setState(newState: AnxietyTestState) {
...
data class AppState(
    ...
    val homeState: HomeViewState = HomeViewState(),
